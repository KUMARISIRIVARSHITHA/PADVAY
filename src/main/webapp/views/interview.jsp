...
<br>
<h2 align=center>Applicants qualified for Interview Round</h2><br/>
...
<td>${ja.deadline}</td>
<td>${ja.progress}</td>
<td><a href="/japselected/${ja.refid}/${ja.email}/${ja.companyname}/${ja.id}"><button class="abutton">Qualify</button></a></td>
<td><a href="/japnotselected/${ja.refid}/${ja.email}/${ja.companyname}/${ja.id}"><button class="abutton">Disqualify</button></a></td>
</tr>

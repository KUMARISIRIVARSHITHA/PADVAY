...
<head>
<title>Aptitude Statistics</title>
...
<br>
<h2 align=center>Applicants qualified for Aptitude Round</h2><br/>
...
<td>${ja.deadline}</td>
<td>${ja.progress}</td>
<td><a href="/japhrtrqualify/${ja.refid}/${ja.email}/${ja.companyname}/${ja.id}"><button class="abutton">Qualify</button></a></td>
<td><a href="/japhrtrdisqualify/${ja.refid}/${ja.email}/${ja.companyname}/${ja.id}"><button class="abutton">Disqualify</button></a></td>
</tr>

...
<div class="row">
  <div class="column">
    ...
    <c:when test="${status == true}">
      <a href="/jobseekerapplyjob/${j.refid}"><button type="button" disabled="${status}">Apply Now</button></a>
    </c:when>
    <c:otherwise>
      <a href="/jobseekerapplyjob/${j.refid}"><button1 type="button" disabled="${status}">Apply Now</button1></a>
    </c:otherwise>
 </c:choose>

...
<div class="bg-img">
    ...
    <input type="text" id="employerid" name="empid" placeholder="" required>
			<br>
    ...
    <input type="text" id="mobilenumber" name="mobile" placeholder="" required>
    		<br>
    <label for="companyName">Company Name</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="text" id="companyName" name="companyName" placeholder="" required>
			<br>
	<label for="companyLoc">Company Location</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="text" id="companyLoc" name="companyLoc" placeholder="" required>
			<br>
	<label for="proof">ID Proof</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="file" id="proof" name="proof" placeholder="imagename.extension" required>
       		<br>

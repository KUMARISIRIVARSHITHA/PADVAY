...
<h1 style="text-align:center;font-size:1.5em;font-weight: normal;color:red">Try Again with other email</h1>
<br>
...
<form id="regForm" method="POST" action="/addjobseekersubmit" modelAttribute="js">
  ...
  WORKS<br><br>
    ...
    LinkedIn profile link:<p><input placeholder="LinkedIn profile link" oninput="this.className = ''" name="linkedin"></p>
    GIT profile link:<p><input placeholder="GIT profile link" oninput="this.className = ''" name="gitlink"></p>
  </div>
  <div class="tab">
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  OTHER DETAILS<br><br>
    ...
    Company Name:<p><input placeholder="If you're student enter NONE" oninput="this.className = ''" name="companyName"></p>
    Experience:<p><input placeholder="If you're student enter NONE" oninput="this.className = ''" name="exp"></p>

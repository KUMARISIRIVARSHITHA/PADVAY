...
<br>
<h2 align=center>Job Applicants</h2><br/>
...
<td>${ja.deadline}</td>
<td>${ja.progress}</td>
<td><a href="/japaptitudequalify/${ja.refid}/${ja.email}/${ja.companyname}/${ja.id}"><button class="abutton">Qualify</button></a></td>
<td><a href="/japaptitudedisqualify/${ja.refid}/${ja.email}/${ja.companyname}/${ja.id}"><button class="abutton">Disqualify</button></a>
</td>
</tr>

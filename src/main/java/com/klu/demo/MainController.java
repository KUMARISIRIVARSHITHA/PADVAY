...
public class MainController 
{
	...
	@GetMapping("/reccontactus")
	public ModelAndView reccontactus()
	{
		ModelAndView mv = new ModelAndView();
		mv.setViewName("reccontactus");
		return mv;
	}  
	
	@PostMapping("/submitreccontactus")
	public String submitreccontactus(@ModelAttribute("contact") Contact contact)
	{
		mainservice.submitreccontactus(contact);
	    return "redirect:/recthankyou";
	}

	
	@GetMapping("/recthankyou")
	public ModelAndView recthankyou()
	{
		ModelAndView mv = new ModelAndView();
		mv.setViewName("recthankyou");
		return mv;
	}  
	...
	public ModelAndView jobseekerviewjobs(HttpSession session)
	{
		String jsemail =(String) session.getAttribute("jsemail");
		List<Job> jsviewjobs=mainservice.getalljobrecords(jsemail);
		ModelAndView mv=new ModelAndView();
	...
	public ModelAndView jobseekerviewjob(@PathVariable("refid") String refid,HttpSession session)
	{
		String jsemail =(String) session.getAttribute("jsemail");
		List<Job> jsviewjobs=mainservice.getjobrecordbyid(refid);
		boolean status=mainservice.getjobrecordbyidstatus(refid,jsemail);
		ModelAndView mv=new ModelAndView();
